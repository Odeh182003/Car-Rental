...
try {
    $pdo = db_connect();
    $query = "SELECT c.carReferenceNumber, c.carModel, c.carType, c.carMake, r.pickup_date, r.return_date, r.pickup_location, r.return_location
              FROM cars c
            ...
            <tbody>
                <?php foreach ($result as $row): ?>
                    <tr>
                        ...
                        <td>
                            <form action="initiate_return.php" method="POST">
